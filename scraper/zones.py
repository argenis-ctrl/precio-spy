...
_ZONE_MAP = [
    ...
    ("rebaje total con intergluteo mas axilas",      "Rebaje Total + Interglúteo + Axilas"),
    ("rebaje total con interglúteo más axilas",     "Rebaje Total + Interglúteo + Axilas"),
    ("rebaje total + intergluteo + axilas",         "Rebaje Total + Interglúteo + Axilas"),
    ("rebaje total con intergluteo",                "Rebaje Total + Interglúteo"),
    ("rebaje total con interglúteo",                "Rebaje Total + Interglúteo"),
